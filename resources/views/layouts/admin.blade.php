    ...
    <div class="wrapper">
        <header class="main-header">
            ...
            <a href="index2.html" class="logo">
                ...
                <span class="logo-mini"><b>Aadmin</b>Amazon</span>
                <!-- logo for regular state and mobile devices -->
                <span class="logo-lg"><b>Admin</b>Amazon</span>
            </a>
            ...
            <ul class="dropdown-menu">
                ...
                <li class="user-header">
                    ...
                    <p>
                        @if(Session::has('admins'))
                            {{ Session::get('admins')->name }}
                        <small>{{ Session::get('admins')->email }}</small>
                        @endif
                    </p>
                </li>
                <!-- Menu Body -->
  ...
  <li class="header">MAIN NAVIGATION</li>
    ...
    <li class="treeview">
      ...
      <ul class="treeview-menu">
        <li><a href="{{ route('product.view')}}"><i class="fa fa-circle-o"></i>Product View</a></li>
      </ul>
    </li>
</ul>
</section>
...
<footer class="main-footer">
  ...
  <strong>Copyright &copy; 2017 <a href="https://adminlte.io">Cominister</a>.</strong> All rights
  reserved.
</footer>
...
@yield('page-script')
@yield('product-update-validation')
</body>
</html>
